...
class Node {
 public:
  ...
  std::map<int, builtin_interfaces::msg::Time> last_publish_stamps_; // 保存上一条消息的时间戳
  std::map<std::string, builtin_interfaces::msg::Time> last_receive_laserscan_stamps_; // 保存上一条消息的时间戳
